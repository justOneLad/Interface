...
function setDefaultBackground(backgroundRadialGradientElement: HTMLElement, darkMode?: boolean) {
  ...
  const defaultLightGradient =
    'radial-gradient(100% 100% at 50% 0%, rgba(0, 206, 209, 0.1) 0%, rgba(255, 255, 255, 0) 100%), #FFFFFF'
  const defaultDarkGradient = 'radial-gradient(100% 100% at 50% 0%, rgba(0, 77, 77, 0.2) 0%, rgba(19, 19, 19, 0) 100%), #131313'
