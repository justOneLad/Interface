...
export const colors = {
  ...
  blue900: '#040E34',
  blueVibrant: '#587BFF',
  // Arc brand colors - purple/burgundy tones
  magenta300: '#6B2949',
  magentaVibrant: '#8B3A5C',
  purple300: '#4A2E6B',
  purple900: '#2C2761',
  purpleVibrant: '#6146A5',
  ...
  networkBase: '#0052FF',
  //NEW COLORS FOR SPORE - Arc brand theme
  neutral1_dark: '#FFFFFF',
  neutral2_dark: '#9B9B9B',
  neutral3_dark: '#5E5E5E',
  surface1_dark: '#1B1525',
  surface2_dark: '#2C2761',
  ...
  accent1_light: '#4A2E6B',
  accent2_light: '#6B2949',
  success: '#40B66B',
  critical: '#FF5F52',
...
const commonTheme = {
  ...
  chain_137_background: colors.gray800,
  ...
  brandedGradient: 'linear-gradient(139.57deg, #2B8A8E 4.35%, #E8A87C 96.44%);',
  promotionalGradient: 'linear-gradient(139.57deg, #2C2761 0%, #6B2949 100%);',
}
