...
export function useRoutingAPIArguments({
  ...
  // UniswapX removed - force all flags to disabled
  const uniswapXForceSyntheticQuotes = false // useUniswapXSyntheticQuoteEnabled()
  const userDisabledUniswapX = true // useUserDisabledUniswapX()
  const userOptedOutOfUniswapX = true // useUserOptedOutOfUniswapX()
  const uniswapXEthOutputEnabled = false // useUniswapXEthOutputEnabled()
  const uniswapXExactOutputEnabled = false // useUniswapXExactOutputEnabled()
  const isUniswapXDefaultEnabled = false // useUniswapXDefaultEnabled()
