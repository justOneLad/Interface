...
export default function SwapPage({ className }: { className?: string }) {
  ...
  const connectedChainId = primaryWallet?.connector?.connectedChain as ChainId | undefined
      ...
      <AutoColumn gap="xs">
        ...
        <div>
          {swapIsUnsupported ? (
            ...
            >
              <ButtonLight onClick={() => setShowAuthFlow(true)} fontWeight={535} $borderRadius="16px">
            ...
            <ButtonPrimary
              $borderRadius="16px"
              onClick={async () => {
                // TODO: Implement chain switching with Dynamic
                // Dynamic handles chain switching through its UI
                console.log('Chain switching requested:', chainId)
              }}
            >
            ...
            >
              <ButtonError
                ...
                style={{ color: '#FFFFFF' }}
              >
                <WhiteText fontSize={20} style={{ color: '#FFFFFF' }}>
                  {swapInputError ? (
                    swapInputError
