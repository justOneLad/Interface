  ...
  ${({ isDarkMode }) =>
    isDarkMode
      ? css`
        ...
        `
      : css`
          background: linear-gradient(rgba(192, 192, 192, 0) 0%, rgb(192 192 192 / 100%) 45%);
        `};
...
const Glow = styled.div`
  ...
  top: 68px;
  bottom: 0;
  background: radial-gradient(72.04% 72.04% at 50% 3.99%, #C0C0C0 0%, rgba(169, 169, 169, 0) 100%);
  filter: blur(72px);
  border-radius: 24px;
  max-width: 480px;
  width: 100%;
...
const TitleText = styled.h1<{ isDarkMode: boolean }>`
  ...
  ${({ isDarkMode }) =>
    isDarkMode
      ? css`
          background: linear-gradient(20deg, rgba(192, 192, 192, 1) 10%, rgba(169, 169, 169, 1) 100%);
        `
      : css`
          background: linear-gradient(10deg, rgba(105, 105, 105, 1) 0%, rgba(128, 128, 128, 1) 100%);
        `};
...
const ButtonCTA = styled(LandingButton)`
  background: linear-gradient(93.06deg, #2C2761 2.66%, #6B2949 98.99%);
  border: 2px solid #6146A5;
  ...
  *, & > *, & span, & p, & div {
  ...
  &:hover {
    box-shadow: 0px 0px 16px 0px #6146A5;
  }
`
...
const AboutContentContainer = styled.div<{ isDarkMode: boolean }>`
  ...
  ${({ isDarkMode }) =>
    isDarkMode
      ? css`
          background: linear-gradient(179.82deg, rgba(0, 0, 0, 0) 0.16%, #2a2a2a 99.85%);
        `
      : css`
          background: linear-gradient(179.82deg, rgba(192, 192, 192, 0) 0.16%, #D3D3D3 99.85%);
        `};
  @media screen and (min-width: ${BREAKPOINTS.md}px) {
    padding: 0 96px 5rem;
  }
      ...
      <PageContainer data-testid="landing-page">
        ...
        <ContentContainer isDarkMode={isDarkMode}>
          ...
          <ActionsContainer>
            ...
            >
              <ButtonCTA as={Link} to="/swap" style={{ color: '#FFFFFF' }}>
                <ButtonCTAText style={{ color: '#FFFFFF' }}>
