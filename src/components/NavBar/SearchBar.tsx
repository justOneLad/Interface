...
export const SearchBar = () => {
  ...
  // NFT search disabled - only search for tokens
  ...
  const [reducedTokens, reducedCollections] = organizeSearchResults(isNFTPage, tokens ?? [], [])
  ...
  // Only search for tokens, no NFT collections
